 ...
 * @typedef {import('@octokit/webhooks').WebhookPayloadPullRequestPullRequest} PullRequest
 ...
 * @param  {import('@octokit/webhooks').WebhookPayloadPullRequestPullRequestBase} base
 *
 ...
 * @param {Status} status
 *
 * @return {Promise<import('@octokit/rest').Octokit.PullsListResponseItem>}
 */
